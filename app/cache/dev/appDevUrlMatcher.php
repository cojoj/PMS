...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Pms\\Bundle\\ProjectsBundle\\Controller\\MainController::indexAction',  '_route' => 'index',);
        }

        // topic_add
        if ($pathinfo === '/topic/add') {
            return array (  '_controller' => 'Pms\\Bundle\\ProjectsBundle\\Controller\\TopicController::addAction',  '_route' => 'topic_add',);
        }
